<div class="modal fade" id="add-ot" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Thêm yêu cầu tăng ca</h5>
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer" style="border: none;">
                    <button type="button" class="btn btn-primary" id="button-modal-add-ot">Thêm</button>
                </div>
            </div>
        </div>
    </div>
